...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\Large Una guía cuántica para el alma moderna \par}
    \vfill
...
\textbf{Navidad de Alta Vibración}
...
\centering
\qrcode[height=3.8cm]{https://open.spotify.com/album/6FkbQuY2d7F09zmG2hqnFK}\\
\vspace{0.5cm}\textbf{Escuchar en Spotify}
\end{minipage}\hfill
\begin{minipage}{0.45\textwidth}
\centering
